      ...
      <div className="section-padding">
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Types of Cookies We Use</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Third-Party Cookies</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-foreground">Updates to This Policy</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
