    ...
    packages: [
      {
        ...
        description:
          "مثالية للأعمال الصغيرة في أعمال السيارات التي ترغب في أتمتة التواصل مع العملاء وعملية الحجز. تشمل روبوت دردشة للإجابة على الأسئلة الشائعة وجمع العملاء المحتملين، وحجز عبر الإنترنت لتقليل المكالمات، وتذكيرات SMS تلقائية لتقليل الغياب.",
        features: [
          "دردشة AI للحجز على مدار الساعة",
          "جدولة فورية",
          "تذكيرات SMS تلقائية",
      ...
      },
      {
        ...
        description:
          "للشركات الراسخة في أعمال السيارات الجاهزة للأتمتة الكاملة والتوسع. تشمل إدارة المكالمات بالذكاء الاصطناعي، لوحة تحكم شاملة للأعمال، وميزات أتمتة متقدمة لأقصى كفاءة.",
        features: [
          "جميع ميزات الباقة الاحترافية",
          "إدارة المكالمات الهاتفية بالذكاء الاصطناعي",
          "تقارير أعمال متقدمة",
