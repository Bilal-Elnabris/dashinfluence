        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-[hsl(217,69%,34%)]">
              ...
              <span className="text-[hsl(36,95%,62%)]">Manual Work</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="p-8 card-hover border border-gray-100">
              <CardContent className="p-0">
                <div className="w-16 h-16 bg-orange-100 rounded-xl flex items-center justify-center mb-6">
                  <BarChart3 className="w-8 h-8 text-[hsl(36,95%,62%)]" />
                </div>
                ...
                <Link href="/calculator" className="flex items-center text-[hsl(36,95%,62%)] font-semibold hover:text-orange-600 transition-colors">
                  Try it now 
            ...
            <Card className="p-8 card-hover border border-gray-100">
              <CardContent className="p-0">
                <div className="w-16 h-16 bg-orange-100 rounded-xl flex items-center justify-center mb-6">
                  <FileText className="w-8 h-8 text-[hsl(36,95%,62%)]" />
                </div>
                ...
                <Link href="/quiz" className="flex items-center text-[hsl(36,95%,62%)] font-semibold hover:text-orange-600 transition-colors">
                  Try it now 
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
              </CardContent>
            ...
            <Card className="p-8 card-hover border border-gray-100">
              <CardContent className="p-0">
                <div className="w-16 h-16 bg-orange-100 rounded-xl flex items-center justify-center mb-6">
                  <Workflow className="w-8 h-8 text-[hsl(36,95%,62%)]" />
                </div>
                ...
                <Link href="/mapper" className="flex items-center text-[hsl(36,95%,62%)] font-semibold hover:text-orange-600 transition-colors">
                  Try it now 
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
              </CardContent>
