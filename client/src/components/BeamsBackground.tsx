...
function createBeam(width: number, height: number): Beam {
  ...
  // Spacy color palette: blue, purple, teal
  const colorPalettes = [
    { hueBase: 210, hueRange: 40 }, // blue (200-240)
    { hueBase: 270, hueRange: 30 }, // purple (260-290)
    { hueBase: 180, hueRange: 20 }, // teal (170-190)
  ];
  const palette =
    colorPalettes[Math.floor(Math.random() * colorPalettes.length)];
  const hue = palette.hueBase + Math.random() * palette.hueRange;
