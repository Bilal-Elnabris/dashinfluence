  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-white rounded-full animate-pulse opacity-30"></div>
        <div className="absolute bottom-1/4 right-1/4 w-1 h-1 bg-yellow-300 rounded-full animate-pulse opacity-50"></div>

        {/* Gradient Orbs */}
        <div
          className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-3xl"
          style={{
            transform: `translateY(${Math.sin(scrollY * 0.01) * 30}px)`,
          }}
        ></div>
        <div
          className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-full blur-3xl"
          style={{
            transform: `translateY(${Math.sin(scrollY * 0.015 + 1) * 20}px)`,
          }}
        ></div>
      </div>
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Link href="/calculator">
                <Button className="group bg-gradient-to-r from-yellow-400 to-orange-400 hover:from-yellow-500 hover:to-orange-500 text-black font-bold text-lg px-8 py-6 rounded-xl shadow-2xl shadow-yellow-400/25 transition-all duration-300 hover:shadow-yellow-400/40 hover:scale-105">
                  <span>Calculate Revenue Loss</span>
                  <ChevronRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Button
                className="group bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 font-bold text-lg px-8 py-6 rounded-xl transition-all duration-300 hover:scale-105"
                onClick={() =>
                  window.open(
