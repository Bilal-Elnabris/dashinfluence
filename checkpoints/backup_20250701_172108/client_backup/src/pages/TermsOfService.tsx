        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-8">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  By accessing and using DashInfluence's website and services,
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  DashInfluence provides AI automation solutions and consulting
                  services for real estate professionals and businesses. Our
                  services include:
                </p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Not engage in any prohibited activities as outlined in these
                    terms
                  </li>
                </ul>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  website and services are owned by DashInfluence or our
                  licensors. This includes but is not limited to text, graphics,
                  logos, software, and methodologies. You may not reproduce,
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  we cannot guarantee uninterrupted access. We reserve the right
                  to modify, suspend, or discontinue any part of our services at
                  any time with or without notice. We are not liable for any
                  loss or inconvenience caused by service interruptions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  To the maximum extent permitted by law, DashInfluence shall
                  not be liable for any indirect, incidental, special,
                  consequential, or punitive damages, including but not limited
                  to loss of profits, data, or business opportunities. Our total
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  written notice. Upon termination, your right to use our
                  services will cease immediately. Provisions that by their
